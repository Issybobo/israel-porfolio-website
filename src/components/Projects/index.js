    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'Web3 Dapps' ?
            <ToggleButton active value="Web3 Dapps" onClick={() => setToggle('Web3 Dapps')}>Web3 Dapps</ToggleButton>
            :
            <ToggleButton value="Web3 Dapps" onClick={() => setToggle('Web3 Dapps')}>Web3 Dapps</ToggleButton>
          }
        </ToggleButtonGroup>
        <CardContainer>
          {toggle === 'all' && projects
